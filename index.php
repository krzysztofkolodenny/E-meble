...
<section class="jumpers">
    ...
    <div class="container">
        ...
        <header>
            ...
            <h1>Aplikacja E-meble</h1>
            <p>Zarządzaj magazynem w prosty i przejrzysty sposób
            </p>
        ...
        <div class="row">
            ...
            <div class="flex-lg-column-reverse align-content-center">

                <figure>
                    <a href="#"><img src="img/truck.jpg" alt=""> </a>
